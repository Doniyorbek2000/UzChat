...
const styles = StyleSheet.create({
  ...
  header: { padding: 20, alignItems: "center", backgroundColor: colors.surface, borderBottomLeftRadius: 20, borderBottomRightRadius: 20 },
  statusRow: { flexDirection: "row", alignItems: "center", gap: 6, marginBottom: 8 },
  statusDot: { width: 10, height: 10, borderRadius: 5 },
  statusText: { fontSize: 12, fontWeight: "700", color: colors.textSecondary, letterSpacing: 0.5 },
  title: { fontSize: 22, fontWeight: "700", color: colors.text, textAlign: "center" },
  host: { fontSize: 14, color: colors.textSecondary, marginTop: 4 },
  ...
  muteBtn: { backgroundColor: colors.surface, paddingHorizontal: 16, paddingVertical: 12, borderRadius: 24 },
