...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: colors.surface, padding: 24, alignItems: "center", marginBottom: 8 },
  avatar: {
    width: 80,
    height: 80,
    borderRadius: 40,
  ...
  botName: { fontSize: 22, fontWeight: "700", color: colors.text },
  botUsername: { fontSize: 14, color: colors.textSecondary, marginTop: 4 },
  description: { fontSize: 14, color: colors.textSecondary, marginTop: 8, textAlign: "center", paddingHorizontal: 20 },
  ...
  ownerText: { fontSize: 14, color: colors.textSecondary },
  emptyCmds: { fontSize: 13, color: colors.textSecondary, fontStyle: "italic" },
  cmdRow: { paddingVertical: 8, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.border },
