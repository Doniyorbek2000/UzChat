...
const styles = StyleSheet.create({
  ...
  botInfo: { flex: 1 },
  botName: { fontSize: 16, fontWeight: "600", color: "#333" },
  botUsername: { fontSize: 13, color: "#888", marginTop: 1 },
  botDesc: { fontSize: 12, color: "#666", marginTop: 4 },
  ...
  cmdCount: { fontSize: 11, color: "#999" },
