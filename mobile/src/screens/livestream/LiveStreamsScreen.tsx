...
const styles = StyleSheet.create({
  ...
  streamCard: { backgroundColor: "#fff", borderRadius: 14, marginBottom: 12, overflow: "hidden" },
  ...
  streamTitle: { fontSize: 16, fontWeight: "600", color: "#333", marginBottom: 4 },
  streamHost: { fontSize: 13, color: "#888" },
