...
const styles = StyleSheet.create({
  ...
  searchInput: { margin: 12, backgroundColor: "#fff", borderRadius: 10, paddingHorizontal: 14, paddingVertical: 10, fontSize: 15, color: "#333" },
  ...
  themeCard: { width: "48%", backgroundColor: "#fff", borderRadius: 12, marginBottom: 10, overflow: "hidden" },
  preview: { height: 120 },
  ...
  themeName: { fontSize: 14, fontWeight: "600", color: "#333" },
  themeDesc: { fontSize: 11, color: "#888", marginTop: 2 },
  themeMeta: { flexDirection: "row", gap: 8, marginTop: 6 },
  themeMetaText: { fontSize: 10, color: "#999" },
