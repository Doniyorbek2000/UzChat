...
const styles = StyleSheet.create({
  ...
  giftCard: { flexDirection: "row", alignItems: "center", backgroundColor: "#fff", borderRadius: 10, padding: 12, marginBottom: 4, gap: 12 },
  giftIcon: { fontSize: 32 },
  giftInfo: { flex: 1 },
  giftName: { fontSize: 15, fontWeight: "600", color: "#333" },
  giftPerson: { fontSize: 12, color: "#888", marginTop: 2 },
  giftMessage: { fontSize: 12, color: "#666", marginTop: 4, fontStyle: "italic" },
  giftDate: { fontSize: 11, color: "#888" },
