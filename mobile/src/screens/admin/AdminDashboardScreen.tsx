...
const styles = StyleSheet.create({
  ...
  healthRow: { flexDirection: "row", justifyContent: "space-between", paddingVertical: 8, borderBottomWidth: 0.5, borderBottomColor: "#E5E5EA" },
  healthLabel: { fontSize: 14, color: "#666" },
  healthValue: { fontSize: 14, fontWeight: "600", color: "#000" },
  menuItem: {
    backgroundColor: "#fff",
    borderRadius: 12,
    padding: 16,
