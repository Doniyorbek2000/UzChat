...
import { sendMessageRateLimiter } from "../../middleware/rateLimit.middleware";
chatsRouter.post("/:id/messages", sendMessageRateLimiter, validateBody(sendMessageSchema), messagesController.send);
